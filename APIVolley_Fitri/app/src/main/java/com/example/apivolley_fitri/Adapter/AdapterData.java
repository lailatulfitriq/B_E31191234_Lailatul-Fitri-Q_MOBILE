package com.example.apivolley_fitri.Adapter;
...
import com.example.apivolley_fitri.Insert;
import com.example.apivolley_fitri.Model.ModelData;
import com.example.apivolley_fitri.R;
...
public class AdapterData extends RecyclerView.Adapter<AdapterData.HolderData>{
    ...
    public AdapterData.HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_row,parent,false);
